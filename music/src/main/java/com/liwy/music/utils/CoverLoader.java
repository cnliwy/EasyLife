...
import com.liwy.easylibrary.common.utils.ImageUtils;
...
public class CoverLoader {
    ...
    public Bitmap loadThumbnail(Music music) {
        ...
        if (TextUtils.isEmpty(path)) {
            ...
            if (bitmap == null) {
                bitmap = BitmapFactory.decodeResource(AppCache.getContext().getResources(), R.drawable.music_default_cover);
